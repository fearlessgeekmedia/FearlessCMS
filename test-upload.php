...
<body>
    ...
    <div class="test-form">
        ...
        <form method="POST" enctype="multipart/form-data">
            <label>Select a file (standard input):</label>
    ...
    <div class="test-form">
        <h2>Test 2: Large File Input</h2>
        <form method="POST" enctype="multipart/form-data">
            <label>Select a file (large input):</label>
            <input type="file" name="test_file" accept="image/*" class="big-file-input">
            <button type="submit">Upload Test File</button>
        </form>
    </div>

    <div class="test-form">
        <h2>Test 3: JavaScript Trigger</h2>
        <input type="file" id="js-file" style="display: none;" accept="image/*">
        <button type="button" onclick="triggerFileInput()">Trigger File Input with JS</button>
    ...
    <div class="test-form">
        ...
        <p><small>Check browser console (F12) for click/change events</small></p>
    </div>

    <div class="test-form">
        <h2>Test 5: Simple Button</h2>
        <button type="button" onclick="alert('Button clicked!')">Test Button Click</button>
        <p><small>This should show an alert if JavaScript is working</small></p>
    </div>
    ...
    <div class="test-form">
        ...
        <p><strong>File API Support:</strong> <span id="file-api">Unknown</span></p>
    ...
    <script>
        ...
        document.getElementById('js-file').addEventListener('change', function() {
            ...
            if (this.files[0]) {
                ...
                console.log('File selected via JS:', this.files[0].name);
            } else {
        ...
        document.addEventListener('click', function(e) {
            console.log('Element clicked:', e.target.tagName, e.target.type, e.target.className);
            if (e.target.type === 'file') {
                console.log('File input clicked:', e.target.id || 'no id');
            }
        });
