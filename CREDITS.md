...
- **Version**: 1.3.6 (via CDN)
- **Description**: A modern rich text editor with an API designed to be easy to use and extend

#### Toast UI Editor (Legacy/Alternative Support)
- **Author**: NHN Cloud
- **Repository**: https://github.com/nhn/tui.editor
- **License**: MIT
- **Description**: Extensible WYSIWYG Editor for Markdown and WYSIWYG modes
...
- **License**: MIT
- **Description**: The primary implementation of Sass

### PHP
- **Author**: The PHP Group
- **License**: PHP License v3.01
- **Description**: Server-side scripting language used for the core CMS logic
...
- **Description**: Web fonts service providing fonts like Fira Code used in Mission Control

### Placeholder Assets
- **Provider**: dummyimage.com
- **Description**: Used for placeholder thumbnails and images in various themes

## Acknowledgments

Special thanks to **James Potts** for architectural contributions to the theme and plugin separation principles.
...
*This file is updated periodically to ensure proper attribution for all third-party components.*